...
// AseanRegionalPage: StatelessWidget Class
class AseanRegionalPage extends StatefulWidget {
  // Static Final Class Properties
  static String title = "ASEAN + REGIONAL";
  static String routeName = "/asean-regional";

  // Constructor
  const AseanRegionalPage({Key? key}) : super(key: key);

  @override
  _AseanRegionalPageState createState() => _AseanRegionalPageState();
}

// _AseanRegionalPageState State Class
class _AseanRegionalPageState extends State<AseanRegionalPage> {
            ...
            Padding(
              ...
              child: InAppWebView(
                initialUrlRequest: URLRequest(
                  ...
                  url: Uri.parse(
                      "https://www.servicetrade.gov.mm/asean-regional"),
                ),
