...
// WtoGatsPage: StatelessWidget Class
class WtoGatsPage extends StatefulWidget {
  // Static Final Class Properties
  static String title = "WTO-GATS";
  static String routeName = "/wto-gats";

  // Constructor
  const WtoGatsPage({Key? key}) : super(key: key);

  @override
  _WtoGatsPageState createState() => _WtoGatsPageState();
}

// _WtoGatsPageState State Class
class _WtoGatsPageState extends State<WtoGatsPage> {
            ...
            Padding(
              ...
              child: InAppWebView(
                initialUrlRequest: URLRequest(
                  ...
                  url: Uri.parse("https://www.servicetrade.gov.mm/wto-gats"),
                ),
