...
// ServicesSectorsPage: StatelessWidget Class
class ServicesSectorsPage extends StatefulWidget {
  // Static Final Class Properties
  static String title = "SERVICES SECTORS";
  static String routeName = "/services-sectors";

  // Constructor
  const ServicesSectorsPage({Key? key}) : super(key: key);

  @override
  _ServicesSectorsPageState createState() => _ServicesSectorsPageState();
}

// _ServicesSectorsPageState State Class
class _ServicesSectorsPageState extends State<ServicesSectorsPage> {
            ...
            Padding(
              ...
              child: InAppWebView(
                initialUrlRequest: URLRequest(
                  ...
                  url: Uri.parse("https://www.servicetrade.gov.mm/sectors"),
                ),
